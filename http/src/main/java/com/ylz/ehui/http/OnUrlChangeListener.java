...
public interface OnUrlChangeListener {
    /**
     * 此方法在框架使用 {@code domainName} 作为 key,从 { RetrofitBaseUrlManager#mDomainNameHub}
     * 中取出对应的 BaseUrl 构建新的 Url 之前会被调用
     * <p>
     * 可以使用此回调确保 { RetrofitBaseUrlManager#mDomainNameHub} 中是否已经存在自己期望的 BaseUrl
     * 如果不存在可以在此方法中进行 { RetrofitBaseUrlManager#putDomain(String, String)}
     *
     * @param oldUrl
     * @param domainName
     */
