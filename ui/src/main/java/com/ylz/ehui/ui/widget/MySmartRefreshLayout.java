...
public class MySmartRefreshLayout extends ViewGroup implements RefreshLayout, NestedScrollingParent/*, NestedScrollingChild*/ {
        ...
        if (!thisView.isInEditMode()) {
            ...
            if (!mManualNestedScrolling && !isNestedScrollingEnabled()) {
                post(new Runnable() {
                    @Override
                    public void run() {
                        final View thisView = MySmartRefreshLayout.this;
                        for (ViewParent parent = thisView.getParent() ; parent != null ; ) {
                            if (parent instanceof NestedScrollingParent) {
                                View target = MySmartRefreshLayout.this;
...
//            int paddingTop = thisView.getPaddingTop();
            if (mRefreshContent != null && mRefreshContent.getView() == child) {
                ...
                final int heightSpec = ViewGroup.getChildMeasureSpec(heightMeasureSpec,
                        paddingTop + thisView.getPaddingBottom() + lp.topMargin + lp.bottomMargin +
...
//                        bottom = top + Math.max(Math.max(0, isEnableRefreshOrLoadMore(mEnableRefresh) ? mSpinner : 0) - lp.bottomMargin - lp.topMargin, 0);
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (mRefreshHeader != null && mRefreshHeader.getView() == child) {
            ...
            if (contentView != null) {
                int bottom = Math.max(contentView.getTop()  + mSpinner, child.getTop());
                ...
                if (!mIsBeingDragged && mDragDirection != 'h' && mRefreshContent != null) {//没有拖动之前，检测  canRefresh canLoadMore 来开启拖动
                    if (mDragDirection == 'v' || (Math.abs(dy) >= mTouchSlop && Math.abs(dx) < Math.abs(dy))) {//滑动允许最大角度为45度
                        ...
                        if (mIsBeingDragged) {
                            ...
                            if (parent != null) {
                                //修复问题 https://github.com/scwang90/MySmartRefreshLayout/issues/580
        ...
        AnimatorListenerAdapter listener = new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mRefreshListener != null) {
                    mRefreshListener.onRefresh(MySmartRefreshLayout.this);
                } else if (mOnMultiPurposeListener == null) {
                    finishRefresh(3000);
                }
                if (mRefreshHeader != null) {
                    mRefreshHeader.onStartAnimator(MySmartRefreshLayout.this, mHeaderHeight,  (int) (mHeaderMaxDragRate * mHeaderHeight));
                }
                if (mOnMultiPurposeListener != null && mRefreshHeader instanceof RefreshHeader) {
                    mOnMultiPurposeListener.onRefresh(MySmartRefreshLayout.this);
...
//    }
    ...
    @Override
    public MySmartRefreshLayout setFooterHeight(float heightDp) {
    ...
    @Override
    public MySmartRefreshLayout setHeaderHeight(float heightDp) {
    ...
    @Override
    public MySmartRefreshLayout setHeaderInsetStart(float insetDp) {
        mHeaderInsetStart = dp2px(insetDp);
        return this;
    }

    @Override
    public MySmartRefreshLayout setFooterInsetStart(float insetDp) {
     ...
     */
    @Override
    public MySmartRefreshLayout setDragRate(float rate) {
        this.mDragRate = rate;
        return this;
    }
     ...
     */
    @Override
    public MySmartRefreshLayout setHeaderMaxDragRate(float rate) {
     ...
     */
    @Override
    public MySmartRefreshLayout setFooterMaxDragRate(float rate) {
     ...
     */
    @Override
    public MySmartRefreshLayout setHeaderTriggerRate(float rate) {
     ...
     */
    @Override
    public MySmartRefreshLayout setFooterTriggerRate(float rate) {
     ...
     */
    @Override
    public MySmartRefreshLayout setReboundInterpolator(@NonNull Interpolator interpolator) {
     ...
     */
    @Override
    public MySmartRefreshLayout setReboundDuration(int duration) {
     ...
     */
    @Override
    public MySmartRefreshLayout setEnableLoadMore(boolean enabled) {
     ...
     */
    @Override
    public MySmartRefreshLayout setEnableRefresh(boolean enabled) {
     ...
     */
    @Override
    public MySmartRefreshLayout setEnableHeaderTranslationContent(boolean enabled) {
     ...
     */
    @Override
    public MySmartRefreshLayout setEnableFooterTranslationContent(boolean enabled) {
     ...
     */
    @Override
    public MySmartRefreshLayout setEnableAutoLoadMore(boolean enabled) {
     ...
     */
    @Override
    public MySmartRefreshLayout setEnableOverScrollBounce(boolean enabled) {
     ...
     */
    @Override
    public MySmartRefreshLayout setEnablePureScrollMode(boolean enabled) {
     ...
     */
    @Override
    public MySmartRefreshLayout setEnableScrollContentWhenLoaded(boolean enabled) {
     ...
     */
    @Override
    public MySmartRefreshLayout setEnableScrollContentWhenRefreshed(boolean enabled) {
     ...
     */
    @Override
    public MySmartRefreshLayout setEnableLoadMoreWhenContentNotFull(boolean enabled) {
     ...
     */
    @Override
    public MySmartRefreshLayout setEnableOverScrollDrag(boolean enabled) {
     ...
     */
    @Override
    public MySmartRefreshLayout setEnableFooterFollowWhenLoadFinished(boolean enabled) {
     ...
     */
    @Override
    public MySmartRefreshLayout setEnableClipHeaderWhenFixedBehind(boolean enabled) {
     ...
     */
    @Override
    public MySmartRefreshLayout setEnableClipFooterWhenFixedBehind(boolean enabled) {
     ...
     */
    @Override
    public MySmartRefreshLayout setDisableContentWhenRefresh(boolean disable) {
     ...
     */
    @Override
    public MySmartRefreshLayout setDisableContentWhenLoading(boolean disable) {
     ...
     */
    @Override
    public MySmartRefreshLayout setRefreshHeader(@NonNull RefreshHeader header) {
     ...
     */
    @Override
    public MySmartRefreshLayout setRefreshHeader(@NonNull RefreshHeader header, int width, int height) {
        if (mRefreshHeader != null) {
     ...
     */
    @Override
    public MySmartRefreshLayout setRefreshFooter(@NonNull RefreshFooter footer) {
     ...
     */
    @Override
    public MySmartRefreshLayout setRefreshFooter(@NonNull RefreshFooter footer, int width, int height) {
        if (mRefreshFooter != null) {
     ...
     */
    @Override
    public MySmartRefreshLayout getLayout() {
        return this;
    }
     ...
     */
    @Override
    public MySmartRefreshLayout setOnRefreshListener(OnRefreshListener listener) {
     ...
     */
    @Override
    public MySmartRefreshLayout setOnLoadMoreListener(OnLoadMoreListener listener) {
     ...
     */
    @Override
    public MySmartRefreshLayout setOnRefreshLoadMoreListener(OnRefreshLoadMoreListener listener) {
        this.mRefreshListener = listener;
        this.mLoadMoreListener = listener;
        this.mEnableLoadMore = mEnableLoadMore || (!mManualLoadMore && listener != null);
        return this;
     ...
     */
    @Override
    public MySmartRefreshLayout setOnMultiPurposeListener(OnMultiPurposeListener listener) {
     ...
     */
    @Override
    public MySmartRefreshLayout setPrimaryColors(@ColorInt int... primaryColors) {
        if (mRefreshHeader != null) {
     ...
     */
    @Override
    public MySmartRefreshLayout setPrimaryColorsId(@ColorRes int... primaryColorId) {
        final View thisView = this;
     ...
     */
    @Override
    public MySmartRefreshLayout setScrollBoundaryDecider(ScrollBoundaryDecider boundary) {
     ...
     */
    @Override
    public MySmartRefreshLayout setNoMoreData(boolean noMoreData) {
     ...
     */
    @Override
    public MySmartRefreshLayout finishRefresh() {
     ...
     */
    @Override
    public MySmartRefreshLayout finishLoadMore() {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
     ...
     */
    @Override
    public MySmartRefreshLayout finishRefresh(int delayed) {
     ...
     */
    @Override
    public MySmartRefreshLayout finishRefresh(boolean success) {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
     ...
     */
    @Override
    public MySmartRefreshLayout finishRefresh(int delayed, final boolean success) {
        ...
        postDelayed(new Runnable() {
            ...
            public void run() {
                if (mState == RefreshState.Refreshing && mRefreshHeader != null && mRefreshContent != null) {
                    ...
                    int startDelay = mRefreshHeader.onFinish(MySmartRefreshLayout.this, success);
                    if (mOnMultiPurposeListener != null && mRefreshHeader instanceof RefreshHeader) {
                    ...
                    if (startDelay < Integer.MAX_VALUE) {
                        if (mIsBeingDragged || mNestedInProgress) {
                            ...
                            MySmartRefreshLayout.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_DOWN, mLastTouchX, mLastTouchY + mSpinner - mTouchSlop*2, 0));
                            MySmartRefreshLayout.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_MOVE, mLastTouchX, mLastTouchY + mSpinner, 0));
     ...
     */
    @Override
    public MySmartRefreshLayout finishLoadMore(int delayed) {
     ...
     */
    @Override
    public MySmartRefreshLayout finishLoadMore(boolean success) {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
     ...
     */
    @Override
    public MySmartRefreshLayout finishLoadMore(int delayed, final boolean success, final boolean noMoreData) {
        postDelayed(new Runnable() {
            @Override
            public void run() {
                if (mState == RefreshState.Loading && mRefreshFooter != null && mRefreshContent != null) {
                    notifyStateChanged(RefreshState.LoadFinish);
                    final int startDelay = mRefreshFooter.onFinish(MySmartRefreshLayout.this, success);
                    if (mOnMultiPurposeListener != null && mRefreshFooter instanceof RefreshFooter) {
                    ...
                    if (startDelay < Integer.MAX_VALUE) {
                        ...
                        if (mIsBeingDragged || mNestedInProgress) {
                            ...
                            MySmartRefreshLayout.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_DOWN, mLastTouchX, mLastTouchY + offset + mTouchSlop * 2, 0));
                            MySmartRefreshLayout.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_MOVE, mLastTouchX, mLastTouchY + offset, 0));
                            if (mNestedInProgress) {
                                mTotalUnconsumed = 0;
                            }
                        }
     ...
     */
    @Override
    public MySmartRefreshLayout finishLoadMoreWithNoMoreData() {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
...
//    @Override
//    @Deprecated
//    public MySmartRefreshLayout resetNoMoreData() {
...
//    }
    ...
    public class RefreshKernelImpl implements RefreshKernel {
        ...
        public RefreshLayout getRefreshLayout() {
            return MySmartRefreshLayout.this;
        }
        ...
        public ValueAnimator animSpinner(int endSpinner) {
            return MySmartRefreshLayout.this.animSpinner(endSpinner, 0, mReboundInterpolator, mReboundDuration);
        }
